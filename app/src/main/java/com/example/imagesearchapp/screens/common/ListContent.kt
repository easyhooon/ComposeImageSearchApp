...
import com.example.imagesearchapp.model.Urls
import com.example.imagesearchapp.model.User
import com.example.imagesearchapp.model.UserLinks
import com.example.imagesearchapp.ui.theme.HeartRed
...
fun UnsplashImagePreview() {
    UnsplashItem(
        unsplashImage = UnsplashImage(
            ...
            urls = Urls(regular = ""),
            likes = 100,
            user = User(username = "Kenshi", userLinks = UserLinks(html = ""))
        )
    )
}
